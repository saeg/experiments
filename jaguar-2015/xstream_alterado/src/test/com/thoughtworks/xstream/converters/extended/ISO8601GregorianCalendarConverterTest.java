...
public class ISO8601GregorianCalendarConverterTest extends TestCase {
    ...
    public void _testRetainsDetailDownToMillisecondLevel() {
        // setup
    ...
    public void _testSavedTimeIsInUTC() {
        Calendar in = Calendar.getInstance();
    ...
    public void _testCanLoadTimeInDifferentTimeZone() {
        Calendar in = Calendar.getInstance();
        String converterXML =  converter.toString(in);
    ...
    public void _testCalendarWithExplicitTimeZone() {
        Calendar timeInMoscow = Calendar.getInstance();
