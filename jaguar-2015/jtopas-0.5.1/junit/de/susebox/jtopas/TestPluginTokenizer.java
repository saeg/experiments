...
//SAEGimport junit.swingui.TestRunner;
  ...
  implements  WhitespaceHandler, SequenceHandler
{
  ...
  private static final TokenizerProperty  OUML_TAG 
    = new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "&ouml;" }, "�", Tokenizer.F_NO_CASE );
  ...
  private static final TokenizerProperty  SZLIG_TAG 
    = new TokenizerProperty(Token.SPECIAL_SEQUENCE, new String[] { "&szlig;" }, "�", Tokenizer.F_NO_CASE );
}
