            ...
            if (codePoint < Character.MIN_SUPPLEMENTARY_CODE_POINT) {
                ...
                switch (c) {
                    ...
                    case '<':
                        ...
                        // escape when in character data or when in a xml attribue val; not needed in html attr val//SAEG - FIXING
                    	//if (!inAttribute || escapeMode == EscapeMode.xhtml)//SAEG - FIXING
                            accum.append("&lt;");
                        else
                            accum.append(c);
                        break;
