...
public class Selector {
    ...
    public static Elements select(String query, Iterable<Element> roots) {
        ...
        LinkedHashSet<Element> elements = new LinkedHashSet<Element>();//SAEG - FAULT
        /*ArrayList<Element> elements = new ArrayList<Element>();
        IdentityHashMap<Element, Boolean> seenElements = new IdentityHashMap<Element, Boolean>();
        // dedupe elements by identity, not equality*///SAEG - FIXING
        
        for (Element root : roots) {
        	elements.addAll(select(evaluator, root));//SAEG - FAULT
