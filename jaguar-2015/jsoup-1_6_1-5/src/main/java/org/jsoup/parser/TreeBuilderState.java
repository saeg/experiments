        ...
        boolean process(Token t, TreeBuilder tb) {
            switch (t.type) {
                ...
                case StartTag:
                    ...
                    } else if (StringUtil.in(name, "base", "basefont", "bgsound", "command", "link", "meta", "noframes", "style", "title")) {//SAEG - FAULT
                    //} else if (StringUtil.in(name, "base", "basefont", "bgsound", "command", "link", "meta", "noframes", "script", "style", "title")) {//SAEG - FIXING                        return tb.process(t, InHead);
                        return tb.process(t, InHead);
                    } else if (name.equals("body")) {
                        tb.error(this);
