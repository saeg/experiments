...
public class Element extends Node {
    ...
    public Element clone() {
        ...
        clone.classNames(); // creates linked set of class names from class attribute //SAEG - FAULT
        //clone.classNames = null; // derived on first hit, otherwise gets a pointer to source classnames //SAEG - FIXING
        return clone;
    }
}
